...
public class RecoveryMgr {
   ...
   public int setInt(Buffer buff, int offset, int newValue) {
      ...
      if (isTempBlock(blk))
         ...
         return new SetIntRecord(txnum, blk, offset, oldValue, newValue).writeToLog();
   }
   ...
   public int setString(Buffer buff, int offset, String newValue) {
      ...
      if (isTempBlock(blk))
         ...
         return new SetStringRecord(txnum, blk, offset, oldValue, newValue).writeToLog();
   }
